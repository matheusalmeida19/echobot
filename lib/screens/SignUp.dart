...
class SignUp_Screen extends StatefulWidget {
  ...
  // O argumento posicional (to) agora inicializa o campo 'show'
  const SignUp_Screen(this.show, {super.key}); 
  // Remova 'void Function() to' e 'required this.show'
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: 10),
              textfield(password, _focusNode2, 'Senha', Icons.password),
              SizedBox(height: 10),
              textfield(
                PasswordConfirm,
                _focusNode3,
